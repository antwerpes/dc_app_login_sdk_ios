    ...
    public class DocCheckLogin: UIViewController {
        ...
        public init(with loginId: String, language: String = "de", templateName: String = "s_mobile") {
            ...
            if #available(iOS 13.0, *) {
                ...
                self.backButtonItem = UIBarButtonItem(image: UIImage(named: "arrow_left", in: bundle, compatibleWith: nil), style: .plain, target: self, action: #selector(backAction))
            }
            ...
            if #available(iOS 13.0, *) {
                ...
                self.forwardButtonItem = UIBarButtonItem(image: UIImage(named: "arrow_right", in: bundle, compatibleWith: nil), style: .plain, target: self, action: #selector(forwardAction))
            }
        }
        ...
        public required init?(coder: NSCoder) {
            ...
            if #available(iOS 13.0, *) {
                ...
                self.backButtonItem.image = UIImage(named: "arrow_left", in: bundle, compatibleWith: nil)
            }
            if #available(iOS 13.0, *) {
                self.forwardButtonItem.image = UIImage(named: "arrow_right", in: bundle, with: nil)
            } else {
                self.forwardButtonItem.image = UIImage(named: "arrow_right", in: bundle, compatibleWith: nil)
            }
        }
        ...
        func isValidToken(_ token: String) -> Bool {
            ...
            do {
                ...
                debugPrint("DocCheckLogin - Received token validation result - boolValid: \(boolValid), intSeconds: \(String(describing: intSeconds)), intProfessionId: \(String(describing: intProfessionId)), strUniqueKey: \(String(describing: strUniqueKey))")
    ...
    extension DocCheckLogin: WKNavigationDelegate {
        ...
        public func webView(_ webView: WKWebView, decidePolicyFor navigationAction: WKNavigationAction, decisionHandler: @escaping (WKNavigationActionPolicy) -> Void) {
            ...
            debugPrint("DocCheckLogin - not login: \(String(describing: navigationAction.request.url?.absoluteString))")
